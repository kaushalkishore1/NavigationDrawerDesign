...
public class FadeSideMenu extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fade_sidemenu);
        ...
        final IProfile profile = new ProfileDrawerItem().withName("kaushal kishore").withEmail("kaushalkishore@gmail.com").withIcon(Uri.parse("https://media.licdn.com/mpr/mpr/shrinknp_200_200/AAEAAQAAAAAAAAKqAAAAJGFjMTU3MjhlLWM4OWItNDdkOC04MzJmLTE1MzI3ZjQxMDRjMA.jpg"));
        final IProfile profile2 = new ProfileDrawerItem().withName("kaushal kishore").withEmail("kaushalkishore@gmail.com").withIcon(Uri.parse("https://media.licdn.com/mpr/mpr/shrinknp_200_200/AAEAAQAAAAAAAAKqAAAAJGFjMTU3MjhlLWM4OWItNDdkOC04MzJmLTE1MzI3ZjQxMDRjMA.jpg"));

        // Create the AccountHeader
        headerResult = new AccountHeaderBuilder()
                .withActivity(this)
                .withHeaderBackground(R.drawable.profilecover)
                .addProfiles(
                        profile, profile2
                )
                ...
                .withOnDrawerItemClickListener(new Drawer.OnDrawerItemClickListener() {
                    ...
                    public boolean onItemClick(View view, int position, IDrawerItem drawerItem) {
                        if (drawerItem instanceof Nameable) {
                            Toast.makeText(FadeSideMenu.this, ((Nameable) drawerItem).getName().getText(FadeSideMenu.this), Toast.LENGTH_SHORT).show();
                        }
