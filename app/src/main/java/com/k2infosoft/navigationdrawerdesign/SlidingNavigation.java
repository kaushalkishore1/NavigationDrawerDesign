...
import com.k2infosoft.navigationdrawerdesign.fragment.HomeFragment;
import com.k2infosoft.navigationdrawerdesign.fragment.MoviesFragment;
import com.k2infosoft.navigationdrawerdesign.fragment.NotificationsFragment;
...
public class SlidingNavigation extends AppCompatActivity {
    ...
    private static final String urlProfileImg = "https://media.licdn.com/mpr/mpr/shrinknp_200_200/AAEAAQAAAAAAAAKqAAAAJGFjMTU3MjhlLWM4OWItNDdkOC04MzJmLTE1MzI3ZjQxMDRjMA.jpg";
    ...
    private void loadNavHeader() {
        // name, website
        txtName.setText("Kaushal kishore");
        txtWebsite.setText("www.k2infosoft.org");
            ...
            public boolean onNavigationItemSelected(MenuItem menuItem) {
                ...
                switch (menuItem.getItemId()) {
                    ...
                    case R.id.nav_about_us:
                        ...
                        startActivity(new Intent(SlidingNavigation.this, AboutUsActivity.class));
                        drawer.closeDrawers();
                        return true;
                    case R.id.nav_privacy_policy:
                        // launch new intent instead of loading fragment
                        startActivity(new Intent(SlidingNavigation.this, PrivacyPolicyActivity.class));
                        drawer.closeDrawers();
                        return true;
                    default:
                        navItemIndex = 0;
