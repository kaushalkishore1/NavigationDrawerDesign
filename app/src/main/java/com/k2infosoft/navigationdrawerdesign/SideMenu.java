...
*/
public class SideMenu extends AppCompatActivity implements ViewAnimator.ViewAnimatorListener {
    ...
    private ScreenShotable fragment;
    ...
    public ScreenShotable onSwitch(Resourceble resourceble, ScreenShotable screenShotable, int position) {
        ...
        switch (resourceble.getName()) {
            ...
            case ContentFragment.BUILDING:
                DemoFragment fragment = DemoFragment.newInstance(primaryColorCanvas);
                getSupportFragmentManager().beginTransaction().replace(R.id.content_frame, fragment).commit();
                return replaceFragment(fragment, position);

            case ContentFragment.MOVIE:
                OneFragment fragment1 = OneFragment.newInstance(primaryColorCanvas);
        ...
        switch (slideMenuItem.getName()) {
          ...
          *//*  case ContentFragment.BUILDING:
            ...
            case ContentFragment.MOVIE:
                ...
                fragmentTransaction.replace(R.id.content_frame, new MoviesFragment()).commit();
            case ContentFragment.BOOK:
                fragmentTransaction = getSupportFragmentManager().beginTransaction();
                fragmentTransaction.replace(R.id.content_frame, new PhotosFragment()).commit();
            case ContentFragment.SHOP:
                fragmentTransaction = getSupportFragmentManager().beginTransaction();
                fragmentTransaction.replace(R.id.content_frame, new NotificationsFragment()).commit();
